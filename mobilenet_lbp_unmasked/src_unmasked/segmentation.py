"""
Segmentation Module - Unmasked Dataset
Handles face detection (without mask detection)
"""
...
class FaceSegmenter:
    ...
    def segment_face(self, image: np.ndarray) -> Dict:
        """
        Complete face segmentation pipeline (without mask detection)
