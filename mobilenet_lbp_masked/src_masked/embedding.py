"""
Embedding Module - Masked Dataset
Generates deep learning embeddings for face recognition (for faces with masks)
"""
...
class FaceEmbedder:
    """Generates face embeddings using deep learning for masked faces"""
