...
End-to-end processing from image to person identification
"""
...
class FaceRecognitionPipeline:
    ...
    def train(self, train_dir: str, val_dir: Optional[str] = None):
        ...
        print(f"Training on {len(train_labels)} samples from {len(set(train_labels))} persons")
